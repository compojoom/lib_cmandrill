...
class CmandrillExports
{
	...
	public function info($id)
	{
		...
		return $this->master->call('exports/info', $params);
	}
	...
	public function getList()
	{
		...
		return $this->master->call('exports/list', $params);
	}
	 ...
	 *     - finished_at string the date and time that the export job was finished as a UTC string in YYYY-MM-DD HH:MM:SS format, or null for
	 *       jobs that have not run
	...
	{
		$params = array("notify_email" => $notify_email);

		return $this->master->call('exports/rejects', $params);
	}
	 ...
	 *     - type string the type of the export job
	 *     - finished_at string the date and time that the export job was finished as a UTC string in YYYY-MM-DD HH:MM:SS format,
	 *       or null for jobs that have not run
	 *     - state string the export job's state
	 *     - result_url string the url for the export job's results, if the job is complete
	 */
	public function whitelist($notify_email = null)
	{
		...
		return $this->master->call('exports/whitelist', $params);
	}
	...
	public function activity($notify_email = null, $date_from = null, $date_to = null, $tags = null, $senders = null, $states = null, $api_keys = null)
	{
		...
		return $this->master->call('exports/activity', $params);
	}
}
